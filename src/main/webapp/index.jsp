...
Her er et link til <a class="mb-4 mt-4" href="FrontController?height=170&weight=65&taget=login">loginsiden</a>
...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style="border-bottom: 2px solid black;">
    ...
    <div class="collapse navbar-collapse mr-4" id="navbarNavDropdown" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="FrontController?height=170&weight=65&taget=login">Login</a>
            </li>
            <li class="nav-item">
